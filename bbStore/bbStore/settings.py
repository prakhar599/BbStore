...
SECRET_KEY = 'django-insecure-vf^gw^9uiob016vic7er8))p4yn6@xqrrd&troe0lbg@z0^q*%'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['prakhar13.pythonanywhere.com']
...
STATIC_URL = '/static/'
STATIC_ROOT = 'home/prakhar13/static'
STATIC_DIR = os.path.join(BASE_DIR,'static')
STATICFILES_DIRS = [
    os.path.join(BASE_DIR,"static"),
    os.path.join(BASE_DIR,"blog/static"),
    os.path.join(BASE_DIR, "static/ckeditor"),  # Add this line
